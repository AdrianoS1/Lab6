...
def print_menu(exits, room_items, inv_items):
    ...
    for ritems in room_items:
        print("TAKE " + ritems["id"].upper() + " to take " + ritems["name"] + ".")

    for pitems in inv_items:
        print("DROP " + pitems["id"].upper() + " to drop your " + pitems["name"] + ".")
    #
    # COMPLETE ME!
    #
